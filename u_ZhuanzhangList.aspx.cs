...
public partial class u_ZhuanzhangList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.Session["PostBack"] = "u_ZhuanzhangList.aspx";
        ...
        else if (!base.IsPostBack)
        {
            ...
            this.AllCount = new ZhuanZhangManager().GetListByStateName(this.userName, this.State, 1).Count;
    ...
    {
        this.zongJiLb.InnerHtml = this.zongJiLb.InnerHtml = "转帐金额共计:&nbsp;&nbsp;" + new ZhuanZhangManager().GetAllMoneyByStateName(this.userName, this.State, 1).allMoney.ToString("F2");
    }
    ...
    private void GetData()
    {
        ...
        this.GridView1.DataSource = new ZhuanZhangManager().GetListByStateName(this.userName, this.State, 1).Skip<ZhuanZhang>(count).Take<ZhuanZhang>(num2).ToList<ZhuanZhang>();
