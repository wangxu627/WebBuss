...
public partial class u_GongGao : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if ((this.NowPage == 1) && (e.Row.RowIndex == 0))
            {
                e.Row.Cells[0].Text = string.Concat(new object[] { "<img src='images/arrow04.gif' />&nbsp;&nbsp;<a href='u_LookGg.aspx?id=", dataItem.id, "'>", dataItem.title, "</a>&nbsp;&nbsp;&nbsp;&nbsp;<img src='images/new.gif' />" });
            }
            else
            {
                e.Row.Cells[0].Text = string.Concat(new object[] { "<img src='images/arrow04.gif' />&nbsp;&nbsp;<a href='u_LookGg.aspx?id=", dataItem.id, "'>", dataItem.title });
            }
            LinkButton button = (LinkButton)e.Row.FindControl("ToSee");
            button.PostBackUrl = "u_LookGg.aspx?id=" + dataItem.id;
