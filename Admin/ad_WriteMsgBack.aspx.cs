...
public partial class Admin_ad_WriteMsgBack : System.Web.UI.Page
{
    private int Id
    {
        get
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (!base.IsPostBack)
        {
            ...
            {
                base.Response.Write("<script type='text/javascript'>alert('非法访问');window.location.href='ad_MsgList.aspx';</script>");
            }
            else
            {
                try
    ...
    protected void toBackDataBt_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                case 0:
                    base.Response.Write("<script type='text/javascript'>alert('页面已过期或者信息已删除，请重新选择');window.location.href='ad_MsgList.aspx';</script>");
                    return;
                ...
                case 2:
                    ...
                    this.Page.ClientScript.RegisterStartupScript(base.GetType(), "", "alert('您不能多次回复同一条信息');", true);
                    return;
            }
        }
    }
    ...
    private void GetData()
    {
        ...
        if (model == null)
        {
            base.Response.Write("<script type='text/javascript'>alert('您查看的邮件已删除');window.location.href='ad_MsgList.aspx';</script>");
        }
        else
        {
