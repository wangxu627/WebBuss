...
public partial class Admin_ad_ChongzhiList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.AllCount = new ChongZhiManager().GetListByState(this.State, this.userName).Count;
    ...
    private void GetData()
    {
        ...
        this.GridView1.DataSource = new ChongZhiManager().GetListByState(this.State, this.userName).Skip<ChongZhi>(count).Take<ChongZhi>(num2).ToList<ChongZhi>();
    ...
    protected void ToOut_Click(object sender, EventArgs e)
    {
        this.GridView1.DataSource = new ChongZhiManager().GetListByState(this.State, this.userName);
        this.GridView1.DataBind();
