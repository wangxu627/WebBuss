...
public partial class Admin_ad_FenHongLog : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.AllCount = new FenHongLogManager().GetList().Count;
    ...
    private void GetData()
    {
        ...
        this.GridView1.DataSource = new FenHongLogManager().GetList().Skip<FenHongLog>(count).Take<FenHongLog>(num2).ToList<FenHongLog>();
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            FenHongLog dataItem = (FenHongLog)e.Row.DataItem;
            e.Row.Attributes.Add("onmouseover", "c=this.style.backgroundColor;this.style.backgroundColor='#FFF6D0'");
            e.Row.Attributes.Add("onmouseout", "this.style.backgroundColor=c");
            e.Row.Cells[0].Text = dataItem.allMoney.ToString("F2");
            e.Row.Cells[1].Text = dataItem.allCount.ToString();
