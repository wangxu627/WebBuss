...
public partial class Admin_ad_DetailAward : System.Web.UI.Page
{
    ...
    private string userName
    {
        get
        {
            ...
            return Convert.ToString(this.ViewState["userName"]);
        }
        set
        {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (!base.IsPostBack)
        {
            try
            {
                this.userName = Convert.ToString(base.Request.QueryString["userName"]);
            }
            catch
            {
                this.userName = "";
            ...
            if (this.userName == "")
            {
                base.Response.Write("<script type='text/javascript'>alert('非法操作');window.location.href='ad_ClearAwardList.aspx';</script>");
            }
            else
            {
                this.AllCount = new DetailedAwardManager().GetListByName(this.userName).Count;
    ...
    private void GetData()
    {
        ...
        this.GridView1.DataSource = new DetailedAwardManager().GetListByName(this.userName).Skip<DetailedAward>(count).Take<DetailedAward>(num2).ToList<DetailedAward>();
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Cells[2].Text = dataItem.refAward.ToString("F2");
            e.Row.Cells[3].Text = dataItem.pengAward.ToString("F2");
            e.Row.Cells[4].Text = dataItem.refPengAward.ToString("F2");
            e.Row.Cells[5].Text = dataItem.fenHongAward.ToString("F2");
            e.Row.Cells[6].Text = dataItem.allAward.ToString("F2");
            e.Row.Cells[7].Text = dataItem.kouOne.ToString("F2");
            e.Row.Cells[8].Text = dataItem.realAward.ToString("F2");
            e.Row.Cells[9].Text = dataItem.markTime.ToString();
        }
    }
    ...
    {
        this.GridView1.DataSource = new DetailedAwardManager().GetListByName(this.userName);
        this.GridView1.DataBind();
