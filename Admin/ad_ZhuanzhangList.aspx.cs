...
public partial class Admin_ad_ZhuanzhangList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.AllCount = new ZhuanZhangManager().GetListByState(this.Flat, this.State, this.userName, 1).Count;
    ...
    {
        ZhuanZhang zhang = new ZhuanZhangManager().GetAllMoneyByState(this.Flat, this.State, this.userName, 1);
    ...
    private void GetData()
    {
        ...
        this.GridView1.DataSource = new ZhuanZhangManager().GetListByState(this.Flat, this.State, this.userName, 1).Skip<ZhuanZhang>(count).Take<ZhuanZhang>(num2).ToList<ZhuanZhang>();
    ...
    {
        this.GridView1.DataSource = new ZhuanZhangManager().GetListByState(this.Flat, this.State, this.userName, 1);
        this.GridView1.DataBind();
