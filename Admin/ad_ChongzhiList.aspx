<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ad_ChongzhiList.aspx.cs"
    Inherits="Admin_ad_ChongzhiList" %>
...
<body>
    ...
    <div id="main">
        ...
        <div id="right">
            ...
            <asp:Button ID="ToOut" runat="server" Text="导出Excel" OnClick="ToOut_Click" />
        </div>
    </div>
    <div id="bottom">
