...
public partial class u_ZhuanzhangListTwo : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (!base.IsPostBack)
        {
            ...
            this.AllCount = new ZhuanZhangManager().GetListByStateName(this.userName, this.State, 2).Count;
    ...
    {
        this.zongJiLb.InnerHtml = this.zongJiLb.InnerHtml = "转帐金额共计:&nbsp;&nbsp;" + new ZhuanZhangManager().GetAllMoneyByStateName(this.userName, this.State, 2).allMoney.ToString("F2");
    }
    ...
    private void GetData()
    {
        ...
        this.GridView1.DataSource = new ZhuanZhangManager().GetListByStateName(this.userName, this.State, 2).Skip<ZhuanZhang>(count).Take<ZhuanZhang>(num2).ToList<ZhuanZhang>();
