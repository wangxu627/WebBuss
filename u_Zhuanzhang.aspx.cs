...
public partial class u_Zhuanzhang : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            this.Session["PostBack"] = "u_Zhuanzhang.aspx";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                switch (new ZhuanZhangManager().AddModel(fromName, toName, allMoney, this.TextBox3.Text.Trim(), 1))
                {
                    case 1:
                        this.TextBox2.Text = "";
                        this.GetData();
